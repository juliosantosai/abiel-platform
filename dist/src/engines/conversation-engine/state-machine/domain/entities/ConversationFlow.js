"use strict";
const FlowStage = require("../valueObjects/FlowStage");
const ValidationError = require("../../../../../shared/errors/ValidationError");
const DomainError = require("../../../../../shared/errors/DomainError");
class ConversationFlow {
    constructor({ id, empresaId, conversationId, etapa = "SALUDO", etapaAnterior = null, contexto = {}, etapasValidas = FlowStage.DEFAULT_STAGES, creadoEn = new Date(), actualizadoEn = new Date() }) {
        if (!id)
