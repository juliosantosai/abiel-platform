"use strict";
const BufferState = require("../valueObjects/BufferState");
const ValidationError = require("../../../../../shared/errors/ValidationError");
const DomainError = require("../../../../../shared/errors/DomainError");
class MessageBuffer {
    constructor({ id, empresaId, conversationId, mensajes = [], estado = "COLLECTING", ventanaMs = 3000, maxMensajes = 10, creadoEn = new Date(), expiraEn = null, actualizadoEn = new Date() }) {
        if (!id)
