...
class ExecuteCapabilityUseCase {
    ...
    async execute({ capabilityName, input = {}, executionContext = {} }) {
        ...
        try {
            ...
            const permissionResult = this.permissionChecker.check({ permissions: executionContext.permissions || [] }, capability.requiredPermissions);
...
//# sourceMappingURL=ExecuteCapabilityUseCase.js.map