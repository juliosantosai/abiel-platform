...
class PrismaDashboardRepository extends DashboardRepository {
    ...
    async obtenerMetricasGlobales(empresaId) {
        ...
        const conversacionesMetricas = MetricasConversacion.desde(this._agruparPorEstadoConversacion(conversacionesCount, "estado"));
...
//# sourceMappingURL=PrismaDashboardRepository.js.map