...
class BloquearConversacionUseCase {
    ...
    async execute({ conversationId, tenantContext }) {
        ...
        if (this.eventPublisher?.publish) {
            await this.eventPublisher.publish(new ConversationLocked({
...
module.exports = BloquearConversacionUseCase;
//# sourceMappingURL=BloquearConversacionUseCase.js.map