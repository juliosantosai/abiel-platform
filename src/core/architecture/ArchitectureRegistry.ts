...
class ArchitectureRegistry {
  ...
  updateStatus(type, id, status, metadata = {}) {
    ...
    let eventType = null;
    if (normalizedStatus === 'STARTED') eventType = COMPONENT_STARTED;
    if (normalizedStatus === 'STOPPED') eventType = COMPONENT_STOPPED;
    if (normalizedStatus === 'FAILED') eventType = COMPONENT_FAILED;
